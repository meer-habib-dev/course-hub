...
const Contact = () => {
    return (
        ...
        <section className="contact-container bottom-padding height-screen flex justify-center align-middle mt-28 mb-2 p-6">
                    ...
                    <form className="contact1-form">
                        ...
                        <div className="container-contact1-form-btn">
                            <button  className="contact1-form-btn">
                                <Link to='/course'><span>Send Email</span></Link>
                            </button>
                        </div>
                    </form>
                </div>
